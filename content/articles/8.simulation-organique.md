...
Featured_image: images/simulations1.png

Cet article fait suite aux [premières simulation du capitalisme à (re)lire ici]({filename}/articles/7.simulation-économique.md).
