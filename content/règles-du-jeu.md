...
3. Enfin on ne peut pas jouer à un autre jeu, ni quitter la partie (enfin si... mais c'est un peu extrême).
...
Enfin le Capitalisme et son toujours gros "C" possède en plus une caractéristique propre à une catégorie spécifique de jeux : il est compétitif.
...
* Comme celle du citoyen, la monnaie citoyenne d'un écosystème a une durée de vie de 30 jours.
* Le citoyen distribue sa monnaie d'investissement comme bon lui semble, en un seul écosystème ou en plusieurs.

Pour mieux comprendre => [Monnaie d'investissement]({filename}/definitions/monnaie-d-investissement.md)
...
Pour mieux comprendre => [Écosystème]({filename}/definitions/ecosysteme.md)
